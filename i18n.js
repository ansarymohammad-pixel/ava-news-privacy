(function () {
  const translations = {
    en: {
      ...
      "Liens importants AVA": "Important AVA links",
      ...
      "Dashboard dynamique": "Dynamic dashboard",
      "Une vue active pour suivre les signaux AVA.": "An active view to track AVA signals.",
      "Chaque carte peut venir du backend FastAPI: prix, impact news, demandes MindMatch et recommandations actualisees.": "Each card can come from the FastAPI backend: prices, news impact, MindMatch requests, and updated recommendations.",
      "Filtres dashboard AVA": "AVA dashboard filters",
      "Tout": "All",
      "Mobilite": "Mobility",
      "Energie": "Energy",
      "Energy": "Energy",
      "Startup": "Startup",
      "Ouvrir le dashboard analytics": "Open analytics dashboard",
      "Intelligence carburant": "Fuel intelligence",
      "Fuel intelligence": "Fuel intelligence",
      "Meilleur SP95 detecte": "Best SP95 detected",
      "Tendance stable": "Stable trend",
      "Home energy planner": "Home energy planner",
      "Planificateur energie maison": "Home energy planner",
      "Meilleur creux 24h": "Best 24h low price",
      "Lancer a 02:00": "Start at 02:00",
      "Planifier appareil": "Plan appliance",
      "Impact engine": "Impact engine",
      "Moteur d'impact": "Impact engine",
      "Credibilite moyenne": "Average credibility",
      "Impact carburant +0.18": "Fuel impact +0.18",
      "Voir les signaux": "View signals",
      "Smart parking": "Smart parking",
      "Parking intelligent": "Smart parking",
      "Disponibilite estimee": "Estimated availability",
      "Risque trafic moyen": "Medium traffic risk",
      "Trouver parking": "Find parking",
      "Startup matching": "Startup matching",
      "Matching startup": "Startup matching",
      "43 profils": "43 profiles",
      "Early access actifs": "Active early access",
      "Rejoindre": "Join",
      "Sources connectees": "Connected sources",
      "Pays suivis": "Tracked countries",
      "Signaux news": "News signals",
      ...
      "Compteur du site": "Site counter",
      "Consulter les visites quotidiennes et le suivi public du site AVA.": "Check daily visits and public AVA site tracking.",
      "Voir le compteur": "View counter",
      "MindMatch Child Safety": "MindMatch Child Safety",
      "Standards CSAE publics pour Google Play et la securite des utilisateurs.": "Public CSAE standards for Google Play and user safety.",
      "Voir la page safety": "View safety page",
    ...
    es: {
      ...
      "Liens importants AVA": "Enlaces importantes AVA",
      ...
      "Dashboard dynamique": "Dashboard dinamico",
      "Une vue active pour suivre les signaux AVA.": "Una vista activa para seguir las senales AVA.",
      "Chaque carte peut venir du backend FastAPI: prix, impact news, demandes MindMatch et recommandations actualisees.": "Cada tarjeta puede venir del backend FastAPI: precios, impacto de noticias, solicitudes MindMatch y recomendaciones actualizadas.",
      "Filtres dashboard AVA": "Filtros del dashboard AVA",
      "Tout": "Todo",
      "Mobilite": "Movilidad",
      "Energie": "Energia",
      "Energy": "Energia",
      "Startup": "Startup",
      "Ouvrir le dashboard analytics": "Abrir dashboard analytics",
      "Intelligence carburant": "Inteligencia de combustible",
      "Fuel intelligence": "Inteligencia de combustible",
      "Meilleur SP95 detecte": "Mejor SP95 detectado",
      "Tendance stable": "Tendencia estable",
      "Home energy planner": "Planificador energetico del hogar",
      "Planificateur energie maison": "Planificador energetico del hogar",
      "Meilleur creux 24h": "Mejor precio bajo 24h",
      "Lancer a 02:00": "Iniciar a las 02:00",
      "Planifier appareil": "Planificar aparato",
      "Impact engine": "Motor de impacto",
      "Moteur d'impact": "Motor de impacto",
      "Credibilite moyenne": "Credibilidad media",
      "Impact carburant +0.18": "Impacto combustible +0.18",
      "Voir les signaux": "Ver senales",
      "Smart parking": "Parking inteligente",
      "Parking intelligent": "Parking inteligente",
      "Disponibilite estimee": "Disponibilidad estimada",
      "Risque trafic moyen": "Riesgo de trafico medio",
      "Trouver parking": "Encontrar parking",
      "Startup matching": "Matching startup",
      "Matching startup": "Matching startup",
      "43 profils": "43 perfiles",
      "Early access actifs": "Early access activos",
      "Rejoindre": "Unirse",
      "Sources connectees": "Fuentes conectadas",
      "Pays suivis": "Paises seguidos",
      "Signaux news": "Senales news",
      "Actions recommandees": "Acciones recomendadas",
      ...
      "Compteur du site": "Contador del sitio",
      "Consulter les visites quotidiennes et le suivi public du site AVA.": "Consultar las visitas diarias y el seguimiento publico del sitio AVA.",
      "Voir le compteur": "Ver contador",
      "MindMatch Child Safety": "Seguridad infantil MindMatch",
      "Standards CSAE publics pour Google Play et la securite des utilisateurs.": "Estandares CSAE publicos para Google Play y la seguridad de los usuarios.",
      "Voir la page safety": "Ver pagina safety",
